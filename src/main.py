...
class Game:
    ...
    def start_screen(self):
        start_surface = pygame.Surface((self.screen.get_width(), self.screen.get_height()))
        font = Font.MINECRAFT_FONT["h2"]
        developer_text = font.render("Developed by free3err", True, (255, 255, 255))
        developer_text_rect = developer_text.get_rect(center=(self.screen.get_width()//2, self.screen.get_height()//2))
