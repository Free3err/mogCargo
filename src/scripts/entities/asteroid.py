...
class Asteroid(pygame.sprite.Sprite):
    ...
    def __init__(self, pos, space):
        ...
        self.size = randint(60, 180)
        self.image = pygame.transform.scale(
            self.img, (self.size, self.size)
        ).convert_alpha()
        ...
        self.shape = pymunk.Circle(self.body, self.size // 2 - 30)
    ...
    def update(self):
        ...
        if current_time > self.next_impulse:
            ...
            impulse_force = uniform(3.33, 13.33)
        ...
        if (
            ...
            or self.body.position.x > Device.SCREEN_WIDTH * 3
            or self.body.position.y < 0
            or self.body.position.y > Device.SCREEN_HEIGHT * 3
        ):
            self.kill()
